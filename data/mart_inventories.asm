...
; Viridian
ViridianCashierText::
	TX_MART POKEBALL,TRANK,ANTIDOTE,PARLYZ_HEAL,BURN_HEAL,MASTER_BALL,RARE_CANDY,THUNDER_STONE

; Pewter
PewterCashierText::
	TX_MART POKEBALL,TRANK,ESCAPE_ROPE,ANTIDOTE,BURN_HEAL,AWAKENING,PARLYZ_HEAL

; Cerulean
CeruleanCashierText::
	TX_MART POKEBALL,TRANK,ESCAPE_ROPE,REPEL,ANTIDOTE,BURN_HEAL,AWAKENING,PARLYZ_HEAL
...
VermilionCashierText::
	TX_MART POKEBALL,SUPER_POTION,ICE_HEAL,AWAKENING,PARLYZ_HEAL,REPEL
...
; Cinnabar
CinnabarCashierText::
	TX_MART ULTRA_BALL,GREAT_BALL,HYPER_POTION,MAX_REPEL,ESCAPE_ROPE,FULL_HEAL,REVIVE,OLD_AMBER,DOME_FOSSIL,HELIX_FOSSIL

; Saffron
SaffronCashierText::
	TX_MART GREAT_BALL,HYPER_POTION,MAX_REPEL,ESCAPE_ROPE,FULL_HEAL,REVIVE,UPGRADE,DUBIOSDISC

; Indigo
IndigoCashierText::
	TX_MART ULTRA_BALL,GREAT_BALL,FULL_RESTORE,MAX_POTION,FULL_HEAL,REVIVE,MAX_REPEL,METAL_COAT,PROTECTOR,MAGMARIZER,ELECTIRIZER
	
; SilphCo
SilphCoCashierText::
	TX_MART UPGRADE,DUBIOSDISC
