...
; Route 20
	db 30,TENTACOOL,HORSEA,JUROB,0
	db 20,CUBONE,0
PokemaniacData:
; Route 10
	db 30,RIHORN,LICKITUNG,0
...
; Unused
	db 42,RIHORN,PRIMEAPE,ARBOK,TAUROS,0
BirdKeeperData:
; Route 13
	db 29,PIDGEY,PIDGEOTTO,0
...
GiovanniData:
; Rocket Hideout B4F
	db $FF,25,ONIX,24,RIHORN,29,PERSIAN,0
; Silph Co. 11F
	db $FF,37,NIDORINO,35,PERSIAN,37,RIHORN,41,NIDOQUEEN,0
	db $FF,65,DUGTRIO,68,PERSIAN,66,NIDOQUEEN,67,NIDOKING,70,RIHORNIOR,72,KANGASKHAN,0
RocketData:
; Mt. Moon B2F
...
BrunoData:
	db $FF,73,ONIX,75,HITMONCHAN,75,HITMONLEE,76,STAHLOS,78,MACHAMP,80,GOLEM,0
BrockData:
	db $FF,12,GEODUDE,14,ONIX,17,VULPIX,18,ZUBAT,0
MistyData:
	db $FF,18,STARYU,21,STARMIE,24,GOLDEEN,26,PSYDUCK,0
LtSurgeData:
	db $FF,28,RAICHU,24,PIKACHU,23,VOLTORB,26,MAGNEMITE,0
ErikaData:
	db $FF,30,TANGELA,32,VICTREEBEL,32,VILEPLUME,0
KogaData:
	db $FF,44,VENONAT,46,VENONAT,48,VENONAT,50,VENONAT,52,VENOMOTH,55,WEEZING,0
BlaineData:
	db $FF,58,NINETALES,60,RAPIDASH,64,ARCANINE,68,CHARIZARD,0
SabrinaData:
	db $FF,50,ABRA,55,KADABRA,60,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
...
LoreleiData:
	db $FF,74,DEWGONG,73,CLOYSTER,74,SLOWBRO,76,JYNX,76,LAPRAS,78,KINGLER,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
...
AgathaData:
	db $FF,76,GENGAR,76,IKSBAT,75,HAUNTER,78,ARBOK,80,GENGAR,82,MUK,0
LanceData:
	db $FF,78,GYARADOS,76,DRAGONAIR,76,DRAGONAIR,80,AERODACTYL,82,DRAGONITE,85,DRAGONITE,0
