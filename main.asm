...
JurobSprite:          INCBIN "gfx/sprites/jurob.2bpp"
...
RihornPicFront:      INCBIN "pic/ymon/rihorn.pic"
RihornPicBack:       INCBIN "pic/monback/rihornb.pic"
...
JurobPicFront:       INCBIN "pic/ymon/jurob.pic"
JurobPicBack:        INCBIN "pic/monback/jurobb.pic"
